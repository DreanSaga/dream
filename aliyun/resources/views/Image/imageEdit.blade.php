...
@endsection  
  <body>
    <div class="x-body">
        <form  method="post" action="{{url('imageEdit')}}" enctype="multipart/form-data">
          {{csrf_field()}}
             ...
             <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="{{$info->img_name}}">
              </div>
          </div>
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="file" id="image" name="images"  autocomplete="off" class="layui-input">
              </div>
        </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                 <img src="{{$info->img_path}}" width="30">
                 <input type="hidden" name="old" value="{{$info->img_path}}">
              </div>
        </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="{{$info->img_link}}">
              </div>
          </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="{{$info->img_sort}}">
              </div>
          </div>
